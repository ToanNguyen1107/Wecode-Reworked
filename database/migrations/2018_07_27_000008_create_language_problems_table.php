...
class CreateLanguageProblemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('language_problems', function (Blueprint $table) {
            $table->increments('id');           
        ...
        Schema::table('language_problems', function (Blueprint $table) {
